...
//@ts-ignore
import YamlWorker from 'worker-loader?{"inline":"fallback"}!@wings-software/monaco-yaml/lib/esm/yaml.worker'
//@ts-ignore
import EditorWorker from 'worker-loader?{"inline":"fallback"}!monaco-editor/esm/vs/editor/editor.worker'
